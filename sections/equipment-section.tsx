...
export function EquipmentSection() {
  ...
  const equipment = [
    {
      id: 1,
      name: "КМУ Kanglim 7 тонн",
      image: "/yellow-crane-truck-manipulator-7-ton-industrial.jpg",
      capacity: "7 тонн",
      boom: "12 м",
      platform: "6.5 x 2.4 м",
      works: [t("jbiProducts"), t("containers"), t("buildingMaterials")],
    },
    {
      id: 2,
      name: "КМУ Hiab 10 тонн",
      image: "/orange-crane-truck-manipulator-10-ton-construction.jpg",
      capacity: "10 тонн",
      boom: "14 м",
      platform: "7.5 x 2.5 м",
      works: [t("heavyLoads"), t("machinery"), t("specialEquipment")],
    },
    {
      id: 3,
      name: "КМУ Unic 12 тонн",
      image: "/blue-crane-truck-manipulator-12-ton-heavy-machiner.jpg",
      capacity: "12 тонн",
      boom: "16 м",
      platform: "8.0 x 2.5 м",
